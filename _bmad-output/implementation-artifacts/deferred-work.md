...
- **[1.7 · LOW] Site-wide internal-link ↔ canonical trailing-slash form mismatch.**
  - **⏩ ASSIGNED → Story 2.0** (Epic 1 retrospective decision, 2026-06-06; Josh): confirmed live in prod at 1.10 as `/about → 301 → /about/` redirect hops. Fix in Epic 2's Story 2.0 cleanup per project-rules.md Rule 2 (pick `trailingSlash` once; links === canonical === sitemap, + a form-equality test).
